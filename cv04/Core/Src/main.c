...
#define SHOW_TIME		1000 //For how long to show alternative value
#define ADC_Q			14   //Exponential accum. coeff.
  ...
  /* USER CODE BEGIN WHILE */
	while(1) {
		...
		if (HAL_GetTick() >= lastDisplayTicks + DISPLAY_PERIOD) {
			...
			// If defined time interval after last button press elapsed
			...
			// Show correct value based on state
			switch(state) {
				case SHOW_POT:
